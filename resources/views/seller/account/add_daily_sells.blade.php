                ...
                <div class="panel-body">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="sells_point_name"
                                placeholder="Sells point name" value="{{old('sells_point_name')}}">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="number" min="0" class="form-control" name="amount_paid"
                                placeholder="Ammount paid" value="{{old('amount_paid')}}">
                        </div>

                        <div class="form-group">
                            <input type="number" min="0" class="form-control" name="amount_left"
                                placeholder="Ammount left" value="{{old('amount_left')}}">
                        </div>
